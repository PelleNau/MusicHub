...
| DEF-R1-013 | `EDT-001`, `PRL-001`, `PRL-002`, `PRL-005`, `VIS-003` | `ST-070`, `ST-030`, `ST-033`, `ST-034`, `ST-082` | Blocker | product-route composition | `/studio/workspace` | `runtime` | Closed | `/studio/workspace` now mounts the piano-roll/editor surface on the product route instead of forcing the mixer baseline, restoring core piano-roll presence, note-edit reachability, and piano-roll parity validation. |
